 ...
 * @node: binary tree node contained by the new node
 ...
 * @node: binary tree node to print then push
...
/**
 * binary_tree_levelorder - traverses a binary tree; level-order traversal
